...
test('benchmark summarizes success, latency, token, screenshot and classifier cost', () => {
  ...
  recorder.record({ name: 'a', application: 'edge', strategy: 'cdp', success: true, latencyMs: 100, inputTokens: 10, classifierCalls: 1, classifierHits: 1, classifierLatencyMs: 8 });
  recorder.record({ name: 'b', application: 'edge', strategy: 'cdp', success: false, latencyMs: 300, screenshots: 1, screenshotBytes: 1000, classifierCalls: 1, classifierLatencyMs: 12 });
